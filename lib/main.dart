  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData(
        ...
        colorScheme: ColorScheme.fromSeed(seedColor: const Color.fromARGB(255, 181, 210, 51)),
      ),
      home: const MyHomePage(title: 'Flutter Demo Wow Home Page'),
    );
  }
}
